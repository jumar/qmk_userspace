...
#define ROW3_RIGHT_BASE                                                 KC_H      , KC_J      , KC_K   , KC_L   , KC_SCLN, KC_QUOT
#define ROW2_RIGHT_BASE                                                 KC_N      , KC_M      , KC_COMM, KC_DOT , KC_SLSH, KC_BSLS
#define ROW1_RIGHT_BASE                                                 KC_ENT   , KC_DEL   , KC_GRV
...
#define ROW4_RIGHT_MOUSE_MEDIA                                                      MS_WHLU, XXXXXXX, MS_UP  , XXXXXXX, MS_WHLU, MS_ACL0
#define ROW3_RIGHT_MOUSE_MEDIA                                                      MS_WHLD, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD, MS_ACL1
#define ROW2_RIGHT_MOUSE_MEDIA                                                      XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, MS_ACL2
#define ROW1_RIGHT_MOUSE_MEDIA                                                      MS_BTN1, KC_MPLY, KC_MFFD
...
#define ROW3_LEFT_RGB UG_TOGG, UG_NEXT, UG_SATU, UG_HUEU, UG_VALU, UG_SPDU
#define ROW2_LEFT_RGB XXXXXXX, UG_PREV, UG_SATD, UG_HUED, UG_VALD, UG_SPDD
...
#define ROW1_RIGHT_RGB                                                      UG_TOGG, XXXXXXX, TG(_5_RGB)
